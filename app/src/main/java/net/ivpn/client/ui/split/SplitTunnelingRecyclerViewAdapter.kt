...
import net.ivpn.client.ui.split.holder.ApplicationInfoViewHolder
import net.ivpn.client.ui.split.holder.AppsSearchViewHolder
import net.ivpn.client.ui.split.items.ApplicationItem
import net.ivpn.client.ui.split.items.SearchItem
import net.ivpn.client.ui.split.items.SplitTunnelingItem
import java.util.*

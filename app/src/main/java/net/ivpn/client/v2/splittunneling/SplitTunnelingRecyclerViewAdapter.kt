...
import net.ivpn.client.databinding.AppsSearchItemBinding
import net.ivpn.client.v2.splittunneling.holder.ApplicationInfoViewHolder
import net.ivpn.client.v2.splittunneling.holder.AppsSearchViewHolder
import net.ivpn.client.v2.splittunneling.items.ApplicationItem
import net.ivpn.client.v2.splittunneling.items.SearchItem
import net.ivpn.client.v2.splittunneling.items.SplitTunnelingItem
import java.util.*

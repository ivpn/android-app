...
class UpdateHelper @Inject constructor(
    ...
    private val currentVersion: String = IVPNApplication.config.versionName
    ...
    private fun registerReceiver() {
        ...
        notificationActionReceiver?.let {
            LocalBroadcastManager.getInstance(IVPNApplication.application).registerReceiver(it, intentFilter)
        }
    }
    ...
    private fun unregisterReceivers() {
        ...
        notificationActionReceiver?.let {
            LocalBroadcastManager.getInstance(IVPNApplication.application).unregisterReceiver(it)
        } ?: return
